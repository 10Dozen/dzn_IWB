/*
	...
	returns: nothing
	exmple:
		["dzn_IWCB_Timeout", "15-30"] call dzn_IWCB_fnc_updateTimeoutSetting
*/
...
if (_newVal isEqualTo [0,0,0] || _newVal isEqualTo DEFAULT_VAL) exitWith { hint "Wrong setting value! Should be in format ""10-30"""; };
