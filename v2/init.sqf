...
dzn_iwb_SpecialAttackChance 		= profileNamespace getVariable ["IWB_AttackChance", 80];
...
dzn_iwb_UGLAttackRange 			= profileNamespace getVariable ["IWB_UGLAttackRange", [35, 325]];
...
// Support weapon (MGs)
dzn_iwb_SWAttackRange 			= profileNamespace getVariable ["IWB_HGAttackRange", [35, 500]];
