...
["dzn_iwb_UGLAttackRangeMin", "SLIDER", "UGL Attack range (min)", "Infantry Weapon Behavior", [15, 400, 35, 0], true, {
	dzn_iwb_UGLAttackRange = [_this, dzn_iwb_UGLAttackRange select 1];
}] call CBA_Settings_fnc_init;
["dzn_iwb_UGLAttackRangeMax", "SLIDER", "UGL Attack range (max)", "Infantry Weapon Behavior", [15, 400, 325, 0], true, {
...
["dzn_iwb_HGAttackRangeMin", "SLIDER", "Hand Grenade Attack range (min)", "Infantry Weapon Behavior", [10, 50, 10, 0], true, {
	dzn_iwb_HGAttackRange = [_this, dzn_iwb_HGAttackRange select 1];
}] call CBA_Settings_fnc_init;
["dzn_iwb_HGAttackRangeMax", "SLIDER", "Hand Grenade Attack range (max)", "Infantry Weapon Behavior", [10, 50, 35, 0], true, {
...
["dzn_iwb_SpecialAttackShortTimeout", "SLIDER", "(Approx.) Attack repreat timeout (sec)", "Infantry Weapon Behavior", [1, 600, 20, 0], true] call CBA_Settings_fnc_init;
